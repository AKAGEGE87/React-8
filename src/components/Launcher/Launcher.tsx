...
const Launcher = () => {
  return (
    <section className="px-[140px] mt-28 mb-[85px]">
      <div className="bg-cover bg-center bg-[url('/images/launcherBG.png')] h-[535px] flex justify-between gap-20 rounded-2xl pl-[76px] py-8">
        <div>
          <div className="flex gap-5 justify-center items-center max-w-[342px] mt-8 mb-6">
            <div className="max-w-[126.75px] w-full max-h-[137.65px] h-screen bg-[#FFAB00] flex justify-center items-center rounded-2xl border-4 border-black">
              <img src="/images/LogoBlack.svg" alt="logo" className="" />
            </div>
